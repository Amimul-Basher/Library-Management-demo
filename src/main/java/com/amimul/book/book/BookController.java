...
public class BookController {
    ...
    public ResponseEntity<PageResponse<BookResponse>> findAllBooks(
        ...
        //Sending connected user because we want to show all books except the ones user already have
    ...
    public ResponseEntity<PageResponse<BookResponse>> findAllBooksByOwner(
        ...
        //Sending connected user because we want to show all the books of associated user
    ...
    public ResponseEntity<Integer> approveReturnForBorrowedBook(@PathVariable("book-id") Integer bookId, Authentication connectedUser) {
        return ResponseEntity.ok(service.approveReturnForBorrowedBook(bookId, connectedUser));
    }
