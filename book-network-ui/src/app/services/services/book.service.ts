...
import { approveReturnForBorrowedBook } from '../fn/book/approve-return-for-borrowed-book';
import { ApproveReturnForBorrowedBook$Params } from '../fn/book/approve-return-for-borrowed-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `approveReturnForBorrowedBook()` */
  static readonly ApproveReturnForBorrowedBookPath = '/books/borrow/return/approved/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approveReturnForBorrowedBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnForBorrowedBook$Response(params: ApproveReturnForBorrowedBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approveReturnForBorrowedBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approveReturnForBorrowedBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnForBorrowedBook(params: ApproveReturnForBorrowedBook$Params, context?: HttpContext): Observable<number> {
    return this.approveReturnForBorrowedBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
